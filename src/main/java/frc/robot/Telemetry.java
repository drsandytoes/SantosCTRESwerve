...
public class Telemetry {
    ...
    StructArrayPublisher<SwerveModuleState> desiredStatePublisher = moduleStats
            .getStructArrayTopic("DesiredModuleState", SwerveModuleState.struct).publish();
    StructArrayPublisher<SwerveModuleState> actualStatePublisher = moduleStats
            .getStructArrayTopic("ActualModuleState", SwerveModuleState.struct).publish();
